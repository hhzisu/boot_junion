            ...
            <div class="sectionInner">
                ...
                <div id="LoginI" class="sectionInnerWrapperLoginI">
                    <form method="post" action="login_ynI">
                        <div class="inputLogin">
                            <input type="email" class="inputJoin" name="user_email" placeholder="이메일" required>
                        </div>
                        <div class="inputLogin">
                            <input type="password" class="inputJoin" name="user_pw" placeholder="비밀번호" required>
                        </div>
                        <div class="inputLogin">
                ...
                <div id="LoginC" class="sectionInnerWrapperLoginC" style="display: none;">
                    <form method="post" action="login_ynC">
                        <div class="inputLogin">
                            <input type="email" class="inputJoin" name="com_email" placeholder="기업 이메일" required>
                        </div>
                        <div class="inputLogin">
                            <input type="password" class="inputJoin" name="com_pw" placeholder="비밀번호" required>
                        </div>
                        <div class="inputLogin">
                            <button class="buttonJoin" type="submit">로그인</button>
                        </div>
