        ...
        <section>
            <div class="sectionInnerFEC">  
                <h3 class="sectionTitleFEC">
                    <a href="#" id="findEmailC" class="findEmail active">이메일 찾기</a>
                    <a href="#" id="findPasswordC" class="findPassword">비밀번호 찾기</a>
                </h3>
                <div class="sectionConFEC">
                    ...
                    <div class="sectionInnerWrapperFEC">
                        ...
                        <form>
                            <div class="inputName">
                                <h3>기업명</h3>
                                <input type="text" class="inputJoin" name="name" placeholder="기업명을 입력해 주세요" required>
                            </div>
                            <div class="inputName">
                                <h3>사업자번호</h3>
                                <input type="text" class="inputJoin" name="comnum" placeholder="사업자번호를 입력해 주세요" required>
                            </div>
            ...
            </div> <!-- 이메일,비밀번호찾기_기업 sectionInnerFEC 끝 -->
        </section>
