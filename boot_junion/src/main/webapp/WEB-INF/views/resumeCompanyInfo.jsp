...
<title>이력서 상세페이지: 기업</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/default.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/resumeCompanyInfo.css">
	...
	<div class="container">
		...
		<section>
            <div class="sectionInner">
                <div class="infoWrap">
                    <h3 class="resumeTitle">자바 백앤드 개발자 이주빈입니다.</h3>
                    <div class="resumeConWrap">
                        <div class="resumeCon left">
                            <div class="resumeConTop">
                                <h5 class="name">이주빈</h5>
                                <div class="ageSex">
                                    <h5 class="age">1999(25세)</h5>
                                    <h5 class="sex">여</h5>
                                </div>
                            </div>
