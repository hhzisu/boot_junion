        ...
        <section>            
            <div class="sectionInnerFE">
                <h3 class="sectionTitleFE">
                    <a href="#" id="findEmail" class="findEmail">이메일 찾기</a>
                    <a href="#" id="findPassword" class="findPassword active">비밀번호 찾기</a>
                </h3>
...
<script>
    ...
    // 비밀번호 찾기 이메일찾기 _개인 기업 탭 (하지수)
        ...
        $('#findEmail').click(function () {
            ...
            $(".sectionInnerConFE").addClass('active');
