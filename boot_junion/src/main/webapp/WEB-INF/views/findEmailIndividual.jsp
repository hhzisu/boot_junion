        ...
        <section>
            <div class="sectionInnerFEI">  
                <h3 class="sectionTitleFEI">
                    <a href="#" id="findEmailI" class="findEmail active">이메일 찾기</a>
                    <a href="#" id="findPasswordI" class="findPassword">비밀번호 찾기</a>
                </h3>
            ...
            </div> <!-- 이메일,비밀번호찾기_개인 sectionInnerFEI 끝 -->
        </section>
